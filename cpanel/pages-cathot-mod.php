...
$e="Modificación de Categoria de Hoteles";
?>
...
<html lang="es">
    <!--<![endif]-->
    <head><!-- Title --><?php libreria::getlLibreria($e); ?>
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        $a_art=$paginador->paginar(consulta::getdevolver(22,"",$_valor1,""),"0","");
                        foreach($a_art as $articulo):
                        ?>
                           <form class="signup-page" <?php echo "action='cathotmod.php?v1=".$articulo['id']."'"; ?> enctype="multipart/form-data" method="POST">
                                <div class="signup-header">
                                    <h2>Modificar Categoria de Hoteles</h2>
                                </div>

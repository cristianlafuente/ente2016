...
$e="Planilla de ingresos de Resto / Bares";
?>
                    ...
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="signup-page" action="resnew.php"  enctype="multipart/form-data" method="POST">
                                ...
                                <input name="horario" class="form-control margin-bottom-20" type="text">
                                ...
                                <div>
                                <!--INSERCION DE LAS ZONAS-->
                                <label><b>Zona: <span class="color-red" /></b></label>
                                <select name="zona">

...
$e="Modificación de Categorias de Restos";
?>
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        $a_art=$paginador->paginar(consulta::getdevolver(24,"",$_valor1,$_valor3),"0","");
                        foreach($a_art as $articulo):
                        ?>
                           <form class="signup-page" <?php echo "action='catresmod.php?v1=".$articulo['id']."'"; ?> enctype="multipart/form-data" method="POST">
                                <div class="signup-header">
                                    <h2>Modificar Categoria de Restos</h2>
                                </div>

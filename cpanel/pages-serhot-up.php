...
$e="Planilla de ingresos de Servicios de Hoteles";
?>
...
<html lang="es">
    ...
    <!-- === END HEADER === -->
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="signup-page" action="serhotnew.php"  enctype="multipart/form-data" method="POST">
                                <div class="signup-header">
                                    <h2>Creando Nuevo Servicios de Hoteles</h2>
                                </div>
        ...
        <!--INSERCION DEL IDIOMA-->
                                <label>Selecion de Tipo de Servicios: <span class="color-red" /></label>

...
$e="Modificación de Servicios de Hoteles";
?>
...
<html lang="es">
    ...
    <!-- === END HEADER === -->
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        $a_art=$paginador->paginar(consulta::getdevolver(20,"",$_valor1,$_valor3),"0","");
                        foreach($a_art as $articulo):
                        ?>
                           <form class="signup-page" <?php echo "action='serhotmod.php?v1=".$articulo['id']."'"; ?> enctype="multipart/form-data" method="POST">
                                <div class="signup-header">
                                    <h2>Modificar Servicios de Hoteles</h2>
                                </div>
        ...
        <!--INSERCION DEL IDIOMA DEL ARTICULO-->
                                ...
                                <select name="tipos_servicios_id">
                                    <option value="0">Selección:</option>
                                    <?php  
                                            $_datos="SELECT id, nombre FROM tipos_servicios";

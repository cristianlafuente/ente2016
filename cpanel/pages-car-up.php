...
$e="Planilla de ingresos de Características";
?>
...
<html lang="es">
    <!--<![endif]-->
    <head>
        <!-- Title --> <?php libreria::getlLibreria($e); ?> <!-- End HEAD-->
    ...
    <!-- === END HEADER === -->
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="signup-page" action="carnew.php"  enctype="multipart/form-data" method="POST">
                                <div class="signup-header">
                                    <h2>Creando Nuevas Características</h2>
                                </div>
        ...
        <!--INSERCION DEL TIPO DE ARTICULO-->
                                <label>Tipo de Características: <span class="color-red" /></label>
                                <input name="tipo" class="form-control margin-bottom-20" type="text">
                                <br /></div>
                                <br />

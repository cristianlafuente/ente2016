...
if($archivo==""){
	$consulta="select archivo from eventos where id='".$_valor1."'";
...
//SE PROCEDE A REALIZAR LA MODIFICACION EN LA TABLA EVENTOS
$insertar="UPDATE EVENTOS SET titulo='".$titulo."', copete='".$copete."', contenido='".$contenido."', tipos_eventos_id='".$tipo_id."', estado='".$estado."', fmodificacion='".$fmodificacion."', idiomas_id='".$idiomas_id."', datos_contactos_id='".$contactos_id."', galerias_id='".$galerias_id."', archivo='".$archivo."', fechaInicio='".$fechainicio."' , fechaFin='".$fechafin."' where id='".$_valor1."'";

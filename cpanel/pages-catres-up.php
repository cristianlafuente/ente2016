...
$e="Planilla de ingresos de Categoria de Restos";
?>
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="signup-page" action="catresnew.php"  enctype="multipart/form-data" method="POST">
                                <div class="signup-header">
                                    <h2>Creando Nueva Categoria de Restos</h2>
                                </div>
